...
public struct AOSBody:Codable {
    ...
    public init(name: String, id: Int, type: AOSType, parent: String = "SolarSystem", coordinates: [SCNVector3] = [], coordinateTimestamps: [Double] = [], targetProperties: TargetProperties? = nil){
        self.id = id
        self.name = name
        self.type = type
        if type == .Asteroid {
